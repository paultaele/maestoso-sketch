...
public class MusicDrawGui implements Runnable {
	...
	private void createMenuBar() {
		...
		JMenuItem newPractice = new JMenuItem("Load Practice");
		newPractice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				loadPractice();
			}
		});
		fileMenu.add(newPractice);
		
		// load quiz menu option
		JMenuItem newQuiz = new JMenuItem("Load Quiz");
	...
	private void createLessonMiddlePanel() {
		...
		myLessonTitleLabel = new JLabel(getFixedText("Welcome to Maestoso Sketch!", LESSON_TITLE_QUESTION_TEXT_LENGTH));
